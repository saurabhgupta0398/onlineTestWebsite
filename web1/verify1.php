...
{
$_SESSION['submittedalready1']="आप पहले ही सबमिट कर चुके हैं!";?>
<div class="alert alert-warning">
<?php
echo $_SESSION['submittedalready1'].'<br/>'; 

echo 'आपके इतने नंबर हैं .......' . $_SESSION['score1'] . ' इतने मे से .......' . $_SESSION['x1'] ;
}?>
</div><?php
$y=0;
$x=0;
$score = 0;
$idarray=$_SESSION['idarray1'];
//for ($z=0; $z <2 ; $z++) {
  //  echo $idarray[$z].'<br/>';
//}
$correctarray=array();
...
{       
    ...
    $result =  $mysqli->query("SELECT * FROM mcq1 WHERE id=$questionId") or die($mysqli->error);
...
//$username="user20";
$starttime=$_SESSION['start_time1'];
if(!isset($_SESSION['resultsaved1'])){
$mysqli->query("INSERT INTO result(username,section,correct,incorrect,unanswered,stime,rtime,score,ip) VALUES('$username','2','$r','$s','$t','$starttime','$timer','$score','$ipadr')")or die($mysqli->error);
$_SESSION['resultsaved1']="result saved";}
