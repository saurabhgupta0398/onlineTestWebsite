...
if(isset($_SESSION['submittedalready2']))
{
	if(!$_GET['id'])
	{
...
$_SESSION['backdeclined2']="You cannot go back";
...
$result=$mysqli->query("SELECT max(stime)as stime FROM result WHERE username='$user' and section='3'");
...
<div class="container">
<?php
require_once "shuffle2.php";
$_SESSION['shuffled2']="questions picked";
$number = 0;
$x=0;
$i=0;
$idarray=array();
$questionsselected=$_SESSION['arr_rows2'];
?>
<form method="POST" action="verify2.php" name="myForm2" id="form3"> 
<?php
while($i<5){
        $number++;  
...
{
	$_SESSION['after1day']="You can only try section 3 on ";
	...
	setInterval(function()
		{
			...
			xmlhttp1.open("GET","response2.php",false);
			xmlhttp1.send(null);
